  ...
  return (
    <div className={styles.hero__container}>
      <div className={styles.hero__featured}>
        <button
          className={styles.hero__button__left}
          onClick={() => go(i - 1)}
        ></button>
          ...
          <div className={styles.hero__banner__track}>
            ...
            >
              <div className={styles.banner__offer__1}>
                ...
                <button className={styles.banner__offer__button__1}>
                  Coming Soon
                </button>
              </div>
            ...
            >
              <div className={styles.banner__offer__3}>
                ...
                <div className={styles.banner__offer__description__3}>
                  Be the first!
                </div>
                <button className={styles.banner__offer__button__3}>
                  Order now
                </button>
              </div>
              <div className={styles.banner__graphyc__3}>
                <div className={styles.banner__graphyc__title__3}>
                  iPhone 14 Pro
                </div>
                <div className={styles.banner__graphyc__description__3}>
                  Pro. Beyond.
                </div>
                <img
        ...
        <button
          className={styles.hero__button__right}
          onClick={() => go(i + 1)}
        ></button>
      </div>
