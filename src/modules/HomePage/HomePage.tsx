...
export const HomePage = () => {
  function filterUniqueProduct(
    arr: ProductData[],
    paramName: keyof ProductData,
  ) {
    const find = new Set();
    ...
    <main className={styles.home}>
      <div className={styles.home__wrapper}>
        <div className={styles.home__container}>
          ...
          <section
            className={styles.newmodels}
            data-slide
            style={newmodelsSlideStyle}
          >
