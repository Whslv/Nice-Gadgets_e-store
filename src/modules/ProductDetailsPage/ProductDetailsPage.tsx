...
export const ProductDetailsPage = () => {
  ...
  const typeOfProduct =
    product?.category || pathname.split('/').find(part => part[1]);
    ...
    try {
      ...
      if (selectedColor && selectedColor !== found.color) {
        const siblings = catalog.filter(
          p => p.namespaceId === found.namespaceId,
        );
      ...
      if (selectedCapacity && selectedCapacity !== found.capacity) {
        ...
        const sameCapacity = siblings.find(
          p =>
            ...
            p.color === (selectedColor || found.color),
        );

        if (sameCapacity) {
          next = sameCapacity;
        } else {
          const anyCapacity = siblings.find(
          ...
          <div className={styles.product__container}>
            ...
            <section className={styles.product__details}>
              ...
              <div className={styles.product__photo}>
                <img
                  src={`./${productPhoto}`}
                  className={styles.product__heroimg}
                ></img>
              </div>

              <div className={styles.product__filters}>
                <div className={styles.product__colors}>
                  <h6 className={styles.product__filters__title}>
                    Available colors
                  </h6>
                  {product?.colorsAvailable.map((color: string) => {
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ['--swatch' as string]:
                            appleColors[col as keyof typeof appleColors] ??
                            '#ccc',
                        }}
                      >
                        <input
                  ...
                  <div className={styles.product__info}>
                    <div className={styles.info__price}>
                      <div className={card.card__price}>
                        <div
                          className={`${card.card__current} ${styles.info__discontPrice}`}
                        >
                          ${product.priceDiscount}
                        </div>
                        <div
                          className={`${card.card__full} ${styles.info__fullPrice}`}
                        >
                    ...
                    <div className={styles.spec__wrapper}>
                      ...
                      <div className={styles.spec__discription}>
                        <div className={styles.spec__container}>
                          ...
                          <div className={styles.spec__info}>
                            {product.screen}
                          </div>
                        </div>
                        <div className={styles.spec__container}>
                        ...
                        <div className={styles.spec__container}>
                          <div className={styles.spec__param}>
                            Built in memory
                          </div>
                          <div className={styles.spec__info}>
                            {product.capacity}
